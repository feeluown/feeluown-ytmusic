...
from PyQt6.QtWidgets import QVBoxLayout, QPushButton, QLabel, QLineEdit, QFormLayout
...
class LoginDialog(LoginDialog_):
    def __init__(self, provider):
        ...
        self.__hint_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
